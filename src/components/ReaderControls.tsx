...
export function ReaderControls() {
  const { focusMode, fontSize, fontFamily, toggleFocusMode, setFontSize, setFontFamily } = useReaderStore();

  return (
    <div className='flex items-center gap-2'>
      {/* Focus Mode Toggle */}
      <Button variant={focusMode ? 'default' : 'outline'} size='sm' onClick={toggleFocusMode} className='h-8 w-8 p-0' aria-label='Toggle focus mode'>
